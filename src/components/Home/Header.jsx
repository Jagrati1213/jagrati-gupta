...
export default function Header() {
  ...
  return (
    <div
      className={`header ${isSticky ? "fixed top-0" : ""}`}
      ref={navScrollRef}
    >
      ...
      <ul className={`${menu ? "h-[31vh]" : "h-0"} lg:h-auto header-ul`}>
        <li className="header-li" onClick={menuToggle}>
        ...
        <li className="header-li" onClick={menuToggle}>
          <a href="#experience" name="Experience">
            Experience
          </a>
        </li>
        <li className="header-li" onClick={menuToggle}>
          <a href="#education" name="Education">
            Education
          </a>
        </li>
        <li className="header-li" onClick={menuToggle}>
          <a href="#project" name="Projects">
            Projects
          </a>
        </li>
      </ul>
