...
export default function Project() {
  ...
  return (
    <div className="w-full py-10 flex flex-col justify-center items-center m-auto"
      id='project'
      data-aos="fade-up">

      <h1 className='heading'>03. Worthy Projects</h1>
                ...
                <div className="card-header">
                  ...
                  <div className="flex justify-between text-xl mb-2">
                    ...
                    <span className='text-white '>
                      <a href={currEle?.gitLink} target="_blank" className='mr-2'>
      ...
      <button onClick={toggleShowBtn} className='show-btn'>{showProjects < projectData.length - 1 ? 'Show More' : 'Show Less'}</button>
