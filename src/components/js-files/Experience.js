    ...
    const workDetails = [
        {
            ...
            des: 'Develop and maintain WordPress websites for clients using custom themes and plugins.',
            workLink: [
                {
                    link: 'https://onzo.in/',
                    projectName: 'Onzo'
        ...
        },
        {
            ...
            des: 'Collaborate with designers, project managers, and backend developers to develop responsive sites.',
            workLink: [
                {
        ...
        },
        {
            ...
            des: 'It\'s a freelancing work, where I use React js, and apis'
        }
    ]
